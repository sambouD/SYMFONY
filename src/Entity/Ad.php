 ...
 * @UniqueEntity(
 * fields={"title"},
 * message="Une autre annonce possède déjà ce titre, merci bien de le modifier"
 * )
 */
class Ad
{
     ...
     * @Assert\Length(min= 20, minMessage="Votre introduction doit faire plus de 20 caratère")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100, minMessage="Votre decription ne peut pas faire moins de 100 caratère")
     */
    private $content;
     ...
     *
     * @return array un table d'objets DateTime représentant les jours d'occupation
     */
