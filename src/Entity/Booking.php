...
class Booking
{
     ...
     * @Assert\Date(message="Attention ! Il faut un format date! ")
    ...
    private $comment;
    /**
     * Callback appelé à chaque fois quon créé une réservation
     * 
     * @ORM\PrePersist
     *
     * @return void
    ...
    public function isBookableDates(){
        // 1) il faut connaire les dates qui sont impossible pour l'annonce
        ...
        //Tableai  des chaines de caractères de mes journées
